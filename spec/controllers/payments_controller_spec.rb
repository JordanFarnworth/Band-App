...
RSpec.describe PaymentsController, type: :controller do
  ...
  describe 'GET index' do
    ...
    let!(:payment) { create :payment, entity: entity }
    ...
    describe 'json request' do
      it 'should return only payments belonging to the logged in entity' do
        pay2 = create :payment, entity: create(:entity)
      ...
      it 'should order payments in descending order by created_at' do
        pay2 = create :payment, entity: entity
        get :index, format: :json
  ...
  describe 'POST create' do
    ...
    it 'should create a new receive payment job upon success' do
      post :create, payment: { amount: 24.99 }, payment_method_nonce: 'asdf'
